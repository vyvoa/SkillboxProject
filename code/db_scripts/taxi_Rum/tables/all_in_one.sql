...
create table taxi_Rum.payment (
                        id                  int generated by default as identity start with 1 increment by 1 not null, -- payment_id
...
create table taxi_Rum.rent (
                        id              int generated by default as identity start with 1 increment by 1 not null, -- rent_id
...
create table taxi_Rum.taxi_order (
                        id                      int generated by default as identity start with 1 increment by 1 not null, -- order_id
...
create table taxi_Rum.way (
                        id                  int generated by default as identity start with 1 increment by 1 not null, -- way_id
...
create table taxi_Rum.refueling (
                        id              int generated by default as identity start with 1 increment by 1 not null, -- refueling
                        driver_id       int not null,
                        car_id          int not null,
                        payment_id      int not null,
                        address_id      int not null,
